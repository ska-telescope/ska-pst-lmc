...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("real_pol_a_mean_freq_avg_masked"),
        ("real_pol_a_variance_freq_avg_masked"),
        ("real_pol_a_num_clipped_samples_masked"),
        ("imag_pol_a_mean_freq_avg_masked"),
        ("imag_pol_a_variance_freq_avg_masked"),
        ("imag_pol_a_num_clipped_samples_masked"),
        ...
        ("real_pol_b_mean_freq_avg_masked"),
        ("real_pol_b_variance_freq_avg_masked"),
        ("real_pol_b_num_clipped_samples_masked"),
        ("imag_pol_b_mean_freq_avg_masked"),
        ("imag_pol_b_variance_freq_avg_masked"),
        ("imag_pol_b_num_clipped_samples_masked"),
    ],
)
