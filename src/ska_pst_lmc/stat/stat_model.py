...
class StatMonitorData:
    ...
    :ivar real_pol_a_mean_freq_avg_rfi_excised: the mean voltage data across channels without RFI for
        polarisation A and the I component
    :vartype real_pol_a_mean_freq_avg_rfi_excised: float
    :ivar real_pol_a_variance_freq_avg_rfi_excised: the variance of voltage data across channels without RFI
    ...
    :ivar imag_pol_a_mean_freq_avg_rfi_excised: the mean voltage data across channels without RFI for
        polarisation A and the Q component
    :vartype imag_pol_a_mean_freq_avg_rfi_excised: float
    :ivar imag_pol_a_variance_freq_avg_rfi_excised: the variance of voltage data across channels without RFI
    ...
    :ivar real_pol_b_mean_freq_avg_rfi_excised: the mean voltage data across channels without RFI for
        polarisation B and the I component
    :vartype real_pol_b_mean_freq_avg_rfi_excised: float
    :ivar real_pol_b_variance_freq_avg_rfi_excised: the variance of voltage data across channels without RFI
    ...
    :ivar imag_pol_b_mean_freq_avg_rfi_excised: the mean voltage data across channels without RFI for
        polarisation B and the Q component
    :vartype imag_pol_b_mean_freq_avg_rfi_excised: float
    :ivar imag_pol_b_variance_freq_avg_rfi_excised: the variance of voltage data across channels without RFI
...
class StatMonitorDataStore(MonitorDataStore[StatMonitorData, StatMonitorData]):
    ...
    def monitor_data(self: StatMonitorDataStore) -> StatMonitorData:
        ...
        total number and the number without RFI. For more information about
        how this can be achieved refer to
