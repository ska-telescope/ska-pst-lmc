...
class StatMonitorData:
    ...
    # Pol A + I (masked)
    real_pol_a_mean_freq_avg_masked: float = 0.0
    real_pol_a_variance_freq_avg_masked: float = 0.0
    real_pol_a_num_clipped_samples_masked: int = 0

    # Pol A + Q (masked)
    imag_pol_a_mean_freq_avg_masked: float = 0.0
    imag_pol_a_variance_freq_avg_masked: float = 0.0
    imag_pol_a_num_clipped_samples_masked: int = 0
    ...
    # Pol B + I (masked)
    real_pol_b_mean_freq_avg_masked: float = 0.0
    real_pol_b_variance_freq_avg_masked: float = 0.0
    real_pol_b_num_clipped_samples_masked: int = 0

    # Pol B + Q (masked)
    imag_pol_b_mean_freq_avg_masked: float = 0.0
    imag_pol_b_variance_freq_avg_masked: float = 0.0
    imag_pol_b_num_clipped_samples_masked: int = 0
...
class StatMonitorDataStore(MonitorDataStore[StatMonitorData, StatMonitorData]):
    ...
    def monitor_data(self: StatMonitorDataStore) -> StatMonitorData:
        ...
        total number and the number not masked. For more information about
